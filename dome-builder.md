...
<main id="dome-app">
    <div class="visual-area">
        ...
        <div class="absolute top-4 left-1/2 -translate-x-1/2 bg-slate-900/80 backdrop-blur p-2 rounded-xl border border-slate-700/80 flex gap-2 shadow-lg z-30">
            ...
            <button onclick="domeSimulator.switchTab('panels')" id="btn-blueprint-mode" class="w-10 h-10 rounded bg-slate-800 hover:bg-pink-900 border border-slate-600 hover:border-pink-400 flex items-center justify-center text-slate-300 hover:text-white transition-all" title="Print/Export Layouts">
    ...
    <div class="side-panel">
        <div class="flex border-b border-slate-700 text-center text-xs">
            ...
            <button id="btn-tab-panels" class="tab-btn flex-1 py-3" onclick="domeSimulator.switchTab('panels')" title="Print">
                <i class="bi bi-printer"></i><span class="hidden md:inline ml-1">Print</span>
            </button>
        </div>
        ...
        <!-- Print Tab -->
        <div id="tab-panels" class="panel-content hidden">
            <div class="section-title"><i class="bi bi-printer"></i> Print & Export</div>
            <div class="param-group">
                <div class="param-item">
                    <div class="text-xs font-bold text-slate-400 uppercase mb-2">Pattern Type</div>
                    <div class="flex gap-1 bg-slate-800 p-1 rounded border border-slate-700">
                        <button id="btn-view-panels" onclick="domeSimulator.setBlueprintViewMode('panels')" class="flex-1 px-3 py-2 rounded-md text-xs font-bold bg-slate-700 text-white transition-colors">
                            <i class="bi bi-scissors mr-1"></i> Panels
                        </button>
                        <button id="btn-view-origami" onclick="domeSimulator.setBlueprintViewMode('origami')" class="flex-1 px-3 py-2 rounded-md text-xs font-bold text-slate-400 hover:text-white transition-colors">
                            <i class="bi bi-box mr-1"></i> Origami Net
                        </button>
                    </div>
                </div>
                ...
                <div class="param-item mt-4">
                    <div class="param-row">
                        <span class="param-label">Scale 1:</span>
                        <span class="param-value font-mono text-sky-400" id="blueprint-scale-display">20</span>
                    </div>
                    <input type="range" id="blueprint-scale-slider" min="1" max="100" value="20" class="slider">
                </div>
                ...
                <div class="mt-6 flex justify-center">
                    <button onclick="domeSimulator.exportBlueprintSVG()" class="w-full py-3 bg-pink-600 hover:bg-pink-500 text-white rounded-lg font-bold shadow-lg shadow-pink-500/20 transition-all flex items-center justify-center">
